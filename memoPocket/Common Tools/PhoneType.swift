...
class PhoneType{
    ...
    static let thisPhone = PhoneType()
    ...
    let type:String =  {
        ...
        if platform == "iPad7,1" { return "iPad Pro 12.9 2G"}
        if platform == "iPad7,2" { return "iPad Pro 12.9 2G"}
        ...
        if platform == "iPad8,5" { return "iPad Pro 12.9 3G"}
        if platform == "iPad8,7" { return "iPad Pro 12.9 3G"}
        if platform == "iPad8,8" { return "iPad Pro 12.9 3G"}
        if platform == "iPad8,6" { return "iPad Pro 12.9 3G"}
        if platform == "iPad8,7" { return "iPad Pro 12.9 3G"}
        if platform == "iPad8,8" { return "iPad Pro 12.9 3G"}
    ...
    func isUsingSafeArea() -> Bool{
        if type == "iPhone X" || type == "iPhone XS" || type == "iPhone XR" || type == "iPhone XS Max" || type == "iPhone 11 Pro Max" || type == "iPhone 11 Pro" || type == "iPhone 11" || type == "iPhone Simulator"{
            return true
        }else{
            return false
        }
